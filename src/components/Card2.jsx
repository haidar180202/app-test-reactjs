...
const Card2 = () => {
  ...
  if (priceAllTshirt < 0) {
    finalPrice = Math.ceil(0 + priceAllTHoodie);
  } else if (priceAllTHoodie < 0) {
    finalPrice = Math.ceil(priceAllTshirt + 0);
  } else {
    finalPrice = Math.ceil(priceAllTshirt + priceAllTHoodie);
  }
